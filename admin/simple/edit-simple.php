...
$id=$_GET['id'];
$query1="select * from simplepure WHERE ID=$id";
$result1=mysqli_query($link, $query1);
$rows1=mysqli_fetch_array($result1);
$sourceimg=$rows1['source-icon'];
if(isset($_POST['edit'])) {
    $id=$_GET['id'];
    $title=$_POST['title'];
    ...
    $query="UPDATE strict.simplepure SET `source-icon`='$source', title='$title', description='$description', `update`='$update' WHERE ID=$id";
...
<div class="row demo-common">
    <div class="col-sm-6 col-md-offset-2 col-md-8">
        <form method="post" enctype="multipart/form-data" action="admin.php?page-layout=edit-simple&id=<?php echo $_GET['id']; ?>">
            ...
            <div class="form-group">
                Title: <input class="form-control title" type="text" value="<?php echo $rows1['title'];?>">
            </div>
            <div class="form-group">
                Description: <input class="form-control input-description des" value="<?php echo $rows1['description'];?>">
            </div>
            <div class="form-group">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="admin.php?page-layout=edit-simple&id=<?php echo $_GET['id']; ?>" method="post">
                            <div class="form-group">
                                Source image: <input class="form-control" name="img-banner" value="<?php if(isset($_FILES[$name]['name'])) {echo $anh;}else{echo $sourceimg;}?>">
                            </div>
                            <div class="form-group">
