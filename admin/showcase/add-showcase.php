...
if(isset($_POST['add'])) {
    ...
    $query="insert into strict.showcase (`source-img`,`title-pro`,`description-pro`, `update`) VALUE ('$source', '$title', '$description', '$update')";
    ...
    <div class="col-sm-6 col-md-offset-2 col-md-8 col-lg-4">
        ...
        <form>
            <div class="form-group">
                Title project: <input class="form-control title-banner" type="text">
            </div>
            <div class="form-group">
                Description project: <input class="form-control input-description des-banner">
            </div>
            <div class="form-group">
